...
public class J15NewController extends Wizard implements INewWizard {
	private J15NewControllerPage page;
	private ISelection selection;

	/**
	 * Constructor for J15NewController.
	 */
	public J15NewController() {
		super();
	...
	public void addPages() {
		page = new J15NewControllerPage(selection);
		addPage(page);
	}
    ...
    public static InputStream openContentStream(
        ...
        try {
            InputStream input = J15NewController.class.getResourceAsStream(
