...
public class J15NewModel extends Wizard implements INewWizard {
	private J15NewModelPage page;
	private ISelection selection;

	/**
	 * Constructor for J15NewModel.
	 */
	public J15NewModel() {
		super();
	...
	public void addPages() {
		page = new J15NewModelPage(selection);
		addPage(page);
	}
    ...
    public static InputStream openContentStream(
        ...
        try {
            InputStream input = J15NewModel.class.getResourceAsStream(
